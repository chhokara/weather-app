...
export default function SideBar({ location, setLocation, weather, updateCoords }) {
        ...
        <div className="w-full h-full bg-gray-200"> {/* Delete div before merging with dev*/}
            <div className="m-0 p-6 w-2/7 h-screen bg-white">
                ...
                <div className="w-full -mt-8 pb-6 text-left border-b">
                    ...
                    <h3 className="text-2xl mx-6"><span>{currentDayOfWeek + ","}</span> <span className="text-gray-500">{time}</span></h3>
                </div>
